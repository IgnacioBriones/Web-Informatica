                    ...
                    <article class="grid_6">
                        ...
                        <div class="wrapper img-indent-bot">
                            ...
                            <div class="extra-wrap">
                                ...
                                Teléfono: 78 77 100 
                                Email:  srojas@utem.cl 
                                <br><h6 class="reg p0"><a class="link" href="#">Títulos y Grados </a></h6>
                                -             Ingeniero de Ejecución en Computación e Informática de la Universidad De Santiago (Chile) obtenido el año 1985.
    <br>.Postìtulo en Sistemas de Informaciòn Administrativos de la Universidad de Chile (Chile) obtenido el año 1993.<br>.
    Magíster en Ciencia de la Computación(e) de la Universidad De Chile (Chile) obtenido el año 1996.<br>.
    Diplomado en Gerencia de Desarrollo de la Universidad de Chile (Chile) obtenido el año 1998.<br>.
    Licenciada en Ciencias de la Ingeniería de la Universidad De Atacama (Chile) obtenido el año 2004.<br>.
                            </div>
                        </div>
                </div>
            </div>
