                ...
                <div class="wrapper">
                    <article class="grid_6">
                        ...
                        <div class="wrapper img-indent-bot">
                            <figure class="img-indent"><img src="<?= base_url() . "images/ptorrealba.jpg" ?>" alt="" /></figure>
                            <div class="extra-wrap">
                                <h6 class="reg p0"><a class="link" href="#">Pamela Torrealba</a></h6>
                                <p><strong>Secretaria de la escuela de informatica. </p></strong>        
                                Teléfono: 78 77 100 
                                Email:  ptorrealba@utem.cl <br>
