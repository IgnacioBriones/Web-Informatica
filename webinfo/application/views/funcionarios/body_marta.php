                    ...
                    <article class="grid_6">
                        ...
                        <div class="wrapper img-indent-bot">
                            ...
                            <div class="extra-wrap">
                                <h6 class="reg p0"><a class="link" href="#">Marta Rojas Estay</a></h6>
                                <p><strong>Jefe de carrera ICCI </p></strong>        
                                Teléfono: 78 77 100 <br>
                                Email:  mrojas@utem.cl <br>
                                <br><h6 class="reg p0"><a class="link" href="#">Títulos y Grados </a></h6>
                                         Ingeniero Civil En Electricidad de la Universidad De Santiago (Chile) obtenido el año 1981.
    Licenciada en Ciencias de la Ingeniería de la Universidad De Santiago (Chile) obtenido el año 1981.
    Magíster Telecomunicaciones ( e) de la Universidad De Santiago (Chile) obtenido el año 2004.
                            </div>
                        </div>
